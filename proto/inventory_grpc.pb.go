...
const (
	InventoryService_AddProduct_FullMethodName = "/proto.InventoryService/AddProduct"
...
func (c *inventoryServiceClient) AddProduct(ctx context.Context, in *AddProductReq, opts ...grpc.CallOption) (*AddProductRes, error) {
...
func (c *inventoryServiceClient) GetProduct(ctx context.Context, in *GetProductReq, opts ...grpc.CallOption) (*GetProductRes, error) {
...
func (UnimplementedInventoryServiceServer) AddProduct(context.Context, *AddProductReq) (*AddProductRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddProduct not implemented")
}
func (UnimplementedInventoryServiceServer) GetProduct(context.Context, *GetProductReq) (*GetProductRes, error) {
